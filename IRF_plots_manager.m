...
% If the Mfiles are *.mod files, using nograph, noprint and graph_format=none in *.mod files are highly recommended to
% speed up the code.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Mfile{1}='New_keynesian_ramsey.mod';
Mfile{2}='New_keynesian_disc.mod';
%%Mfile{3}='New_keynesian.mod';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% If the IRFs of some variables are needed, variable names are just needed
% in the first VList and @ sign can be used in the others. For example if
% just y, c, i and h are the preferred variables the following format is
% needed:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The IRFs of which shocks to be drawn
% The Slist{i} includes the shocks in the Mfile{i}
% The order is important for cross mod files
% To plot all the shocks leave it empty
% CAUTION: In the last case ensure that all shocks have the same order in
% all *.mod files. Use @ sign instead of repeating the shocks name in the
% remaining SLists
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
